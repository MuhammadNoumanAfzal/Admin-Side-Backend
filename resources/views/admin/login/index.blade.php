            ...
            <div class="login-container d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid p-8">
                <div class="login-content d-flex flex-column card p-5 p-md-10">
                    <a href="{{ route('adminpnlx') }}" class="login-logo pb-8 text-center">
                        <img src="{{ asset('img/logo-white.png') }}" class="max-h-80px" alt="Logo" /> </a>
                        ...
                        <form action="{{ route('adminpnlx') }}" method="post" class="form" id="kt_login_singin_form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" placeholder="Email"
                                    class="form-control form-control-solid h-auto py-5 px-6 rounded-lg border-0 @error('email') is-invalid @enderror"
                                    value="{{ old('email') }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" placeholder="Password"
                                    class="form-control form-control-solid h-auto py-5 px-6 rounded-lg border-0 @error('password') is-invalid @enderror"
