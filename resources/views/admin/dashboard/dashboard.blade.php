...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            ...
            <!-- User Status Chart -->
            {{-- Make sure you have this canvas somewhere in your layout/view if you want the pie chart --}}
            {{-- <div style="height:300px"><canvas id="userStatusChart"></canvas></div> --}}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (statusElement) {
        ...
        const activeUsers = {{ (int)($activeUsers ?? 0) }};
        const deletedUsers = {{ (int)($deletedUsers ?? 0) }};
        const totalUsers = {{ (int)($totalUsers ?? 0) }};
