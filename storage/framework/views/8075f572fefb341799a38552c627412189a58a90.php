...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <?php echo e(Form::open(['method' => 'get', 'route' => "$model.index", 'class' => 'kt-form kt-form--fit mb-0', 'autocomplete' => 'off'])); ?>
                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="<?php echo e(route("$model.create")); ?>" class="btn btn-primary">Add New Notification</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div id="collapseSearch" class="collapse" data-parent="#accordionExample">
                                    <div class="row mb-6">
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            <label>Title</label>
                                            <input type="text" class="form-control" name="title" placeholder="Search by title" value="<?php echo e($searchVariable['title'] ?? ''); ?>">
                                        </div>
                                        ...
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <select name="user_id" class="form-control select2">
                                                ...
                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($user->id); ?>" <?php echo e(isset($searchVariable['user_id']) && $searchVariable['user_id'] == $user->id ? 'selected' : ''); ?>>
                                    ...
                                    <div class="row mb-6">
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <input type="text" class="form-control datepicker" name="date_from" placeholder="Date From" value="<?php echo e($searchVariable['date_from'] ?? ''); ?>" readonly>
                                        </div>
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            <label>Date To</label>
                                            <input type="text" class="form-control datepicker" name="date_to" placeholder="Date To" value="<?php echo e($searchVariable['date_to'] ?? ''); ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="row mt-8">
                                        <div class="col-lg-12">
                                            ...
                                            <tr>
                                                <td>
                                                    <?php if(!empty($result->image)): ?>
                                                        <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo e(Config::get('constants.NOTIFICATION_IMAGE_PATH').$result->image); ?>">
                                                            <img src="<?php echo e(Config::get('constants.NOTIFICATION_IMAGE_PATH').$result->image); ?>" width="50" height="50">
                                                        </a>
                                                    <?php else: ?>
                                                ...
                                                <td><?php echo e(Str::limit($result->description, 50)); ?></td>
                                                <td>
                                                    <?php if($result->user): ?>
                                                        <?php echo e($result->user->name); ?>

                                                    <?php elseif($result->user_ids): ?>
                                                        <a href="javascript:void(0);" 
                                                           class="text-info view-all-users" 
                                                           data-user-ids="<?php echo e($result->user_ids); ?>"
                                                           data-notification-title="<?php echo e($result->title); ?>"
                                                           data-toggle="modal" 
                                                           data-target="#usersModal">
                                                            All Users (<?php echo e(count(explode(',', $result->user_ids))); ?>)
                                                        </a>
                                                    <?php else: ?>
                                                ...
                                                <td class="text-right">
                                                 <a href="<?php echo e(route("$model.sendNow", base64_encode($result->id))); ?>" class="btn btn-icon btn-light btn-hover-info btn-sm" title="Send Now">
                                                            <i class="la la-paper-plane"></i>
                                                        </a>
                                                    <a href="<?php echo e(route("$model.delete", base64_encode($result->id))); ?>" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" title="Delete">
...
<script>
    $(document).ready(function() {
        ...
        $('.view-all-users').on('click', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.getUsersByIds")); ?>',
                type: 'POST',
                data: {
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin-Side-Backend\resources\views/admin/user-notifications/index.blade.php ENDPATH**/ ?>