            ...
            <div class="login-container d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid p-8">
                <div class="login-content d-flex flex-column card p-5 p-md-10">
                    <a href="<?php echo e(route('adminpnlx')); ?>" class="login-logo pb-8 text-center">
                        <img src="<?php echo e(asset('img/logo-white.png')); ?>" class="max-h-80px" alt="Logo" /> </a>
                        ...
                        <form action="<?php echo e(route('adminpnlx')); ?>" method="post" class="form" id="kt_login_singin_form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" placeholder="Email"
                                    class="form-control form-control-solid h-auto py-5 px-6 rounded-lg border-0 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mt-n5">
                                    ...
                                    <a href="<?php echo e(route('forgetPassword')); ?>"
                                        class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">
                                        Forgot Password ?
                                    </a>
                                </div>
                                <input type="password" name="password" placeholder="Password"
                                    class="form-control form-control-solid h-auto py-5 px-6 rounded-lg border-0 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.layouts.login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin-Side-Backend\resources\views/admin/login/index.blade.php ENDPATH**/ ?>