            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                       <?php echo e(Config('constants.TEMPLE.TEMPLE_TITLES')); ?>
                ...
                <div class="card card-custom card-stretch card-shadowless">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href='<?php echo e(route("$model.create")); ?>' class="btn btn-primary"> <?php echo e(trans("Add New ")); ?><?php echo e(Config('constants.TEMPLE.TEMPLE_TITLE')); ?></a>
                        </div>
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin-Side-Backend\resources\views/admin/temples/index.blade.php ENDPATH**/ ?>